...
const CourseCard: FC<Props> = ({ item, isProfile }) => {
    ...
    dark:shadow-[bg-slate-700] rounded-lg p-3 shadow-sm  dark:shadow-inner
            ...
            '>
                ...
                <Image width={500} height={300} objectFit='contain' className=' rounded w-full' src={item.thumbnail.url} alt="" />
                <br />
                ...
                <div className=' w-full flex items-center justify-between pt-2'>
                    ...
                    <h5
                        className={` text-black dark:text-[#fff] ${isProfile && "hidden  800px:inline-block"
                            }`}
                    >
