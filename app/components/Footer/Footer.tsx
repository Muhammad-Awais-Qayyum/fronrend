                ...
                <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
                    ...
                    <div>
                        ...
                        <p className="text-base text-black dark:text-gray-300 dark:hover:text-white pb-2">
                            Address: Mohalla Faiza Abad, Faqirwali
                        </p>
                        <p className="text-base text-black dark:text-gray-300 dark:hover:text-white pb-2">
                            Mail Us: awaisquyyum010.com
                        </p>
                    </div>
                </div>
            </div>
            <br />
            <p className="text-center text-black mb-4 dark:text-white">
                Copyright ©️ 2023 SmartStudy®️ | All Rights Reserved
            </p>
        </footer>
    )
}
