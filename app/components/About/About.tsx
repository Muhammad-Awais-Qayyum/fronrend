  ...
  return (
    <div className="text-black dark:text-white">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text-gradient-light  dark:bg-gradient-to-r from-[#7e5fd8] to-[#4e88c5] text-transparent">Smart-Study?</span>
      </h1>
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          <br />
          <br />
          As the founder and CEO of Smart-Study, I know firsthand the challenges
          that come with learning and growing in the programming industry.
          That&apos;s why I created Smart-Study &ndash; to provide new
          ...
          <br />
          <br />
          At Smart-Study, we believe that price should never be a barrier to
          ...
          <br />
          <br />
          But Smart-Study is more than just a community &ndash; we&apos;re a
          ...
          <br />
          <br />
          With Smart-Study by your side, there&apos;s nothing standing between
          ...
          <br />
          <br />
          So what are you waiting for? Join the Smart-Study family today and
        ...
        <br />
        <span className="text-[22px]">AwaisQayyum&apos;s</span>
        <h5 className="text-[18px] font-Poppins">
          Founder and CEO of Smart-Study
        </h5>
        <br />
        <br />
        <br />
